...
struct http_negotiation {
  ...
  _BIT_(h2_upgrade);  /* Do HTTP Upgrade from 1.1 to 2 */
  _BIT_(h2_prior_knowledge); /* Directly do HTTP/2 without ALPN/SSL */
  _BIT_(accept_09); /* Accept an HTTP/0.9 response */
  _BIT_(only_10); /* When using major version 1x, use only 1.0 */
};
