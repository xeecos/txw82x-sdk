...
extern void *mbedtls_mem_alloc(size_t size);
extern void mbedtls_mem_free(void *ptr);
extern void *mbedtls_mem_calloc(size_t nmemb, size_t size);
...
void *mbedtls_mem_calloc(size_t nmemb, size_t size)
{
    void *ptr = mbedtls_mem_alloc(nmemb * size);
    if (ptr) {
