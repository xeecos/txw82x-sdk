...
/* management */
#define WLAN_STYPE_ASSOC_REQ        0x0000
#define WLAN_STYPE_ASSOC_RESP       0x0010
#define WLAN_STYPE_REASSOC_REQ      0x0020
#define WLAN_STYPE_REASSOC_RESP     0x0030
#define WLAN_STYPE_PROBE_REQ        0x0040
#define WLAN_STYPE_PROBE_RESP       0x0050
#define WLAN_STYPE_BEACON           0x0080
#define WLAN_STYPE_ATIM             0x0090
#define WLAN_STYPE_DISASSOC         0x00A0
#define WLAN_STYPE_AUTH             0x00B0
#define WLAN_STYPE_DEAUTH           0x00C0
#define WLAN_STYPE_ACTION           0x00D0

/* control */
#define WLAN_STYPE_CTL_EXT          0x0060
#define WLAN_STYPE_BACK_REQ         0x0080
#define WLAN_STYPE_BACK             0x0090
#define WLAN_STYPE_PSPOLL           0x00A0
#define WLAN_STYPE_RTS              0x00B0
#define WLAN_STYPE_CTS              0x00C0
#define WLAN_STYPE_ACK              0x00D0
#define WLAN_STYPE_CFEND            0x00E0
#define WLAN_STYPE_CFENDACK         0x00F0

/* data */
#define WLAN_STYPE_DATA             0x0000
#define WLAN_STYPE_DATA_CFACK       0x0010
#define WLAN_STYPE_DATA_CFPOLL      0x0020
#define WLAN_STYPE_DATA_CFACKPOLL   0x0030
#define WLAN_STYPE_NULLFUNC         0x0040
#define WLAN_STYPE_CFACK            0x0050
#define WLAN_STYPE_CFPOLL           0x0060
#define WLAN_STYPE_CFACKPOLL        0x0070
#define WLAN_STYPE_QOS_DATA         0x0080
#define WLAN_STYPE_QOS_DATA_CFACK   0x0090
#define WLAN_STYPE_QOS_DATA_CFPOLL  0x00A0
#define WLAN_STYPE_QOS_DATA_CFACKPOLL   0x00B0
#define WLAN_STYPE_QOS_NULLFUNC     0x00C0
#define WLAN_STYPE_QOS_CFACK        0x00D0
#define WLAN_STYPE_QOS_CFPOLL       0x00E0
#define WLAN_STYPE_QOS_CFACKPOLL    0x00F0
...
#define WLAN_FC_STYPE_ACTION_NOACK  14
...
#define WLAN_ACTION_UNPROT_DMG 20
#define WLAN_ACTION_VHT  21
#define WLAN_ACTION_UNPROTECTED_S1G  22
#define WLAN_ACTION_S1G_UNPROTECTED  WLAN_CATEGORY_UNPROTECTED_S1G
#define WLAN_ACTION_S1G_RELAY  23
#define WLAN_ACTION_S1G_FLOW_CONTROL  24
#define WLAN_ACTION_S1G_CONTROL_RESP_MCS_NGT 25
 ...
 */
static inline int ieee80211_has_tods(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_TODS)) != 0;
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_fromds(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_FROMDS)) != 0;
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_a4(le16 fc)
{
    le16 tmp = cpu_to_le16(WLAN_FC_TODS | WLAN_FC_FROMDS);
    return (fc & tmp) == tmp;
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_morefrags(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_MOREFRAG)) != 0;
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_retry(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_RETRY)) != 0;
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_pm(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_PWRMGT)) != 0;
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_moredata(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_MOREDATA)) != 0;
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_protected(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_PROTECTED)) != 0;
}
...
{
    return (fc & cpu_to_le16(WLAN_FC_ORDER | WLAN_FC_PVER)) == cpu_to_le16(WLAN_FC_ORDER);
}
...
static inline u8 ieee80211_is_qmf(le16 fc)
{
    if(ieee80211_is_mgmt(fc) && (fc & cpu_to_le16(WLAN_FC_TODS))) {
        return 1;
    } else {
        return 0;
    }
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline u8 ieee80211_is_data_qos(le16 fc)
{
    /*
     * mask with QOS_DATA rather than IEEE80211_FCTL_STYPE as we just need
     * to check the one bit
     */
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_STYPE_QOS_DATA)) ==
           cpu_to_le16(WLAN_FTYPE_DATA | WLAN_STYPE_QOS_DATA);
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline u8 ieee80211_is_data_present(le16 fc)
{
    /*
     * mask with 0x40 and test that that bit is clear to only return true
     * for the data-containing substypes.
     */
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_STYPE_NULLFUNC)) ==
           cpu_to_le16(WLAN_FTYPE_DATA);
}
...
static inline bool ieee80211_is_probe_resp(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_FC_STYPE)) ==
           cpu_to_le16(WLAN_FTYPE_MGMT | WLAN_STYPE_PROBE_RESP);
}
...
{
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_FC_STYPE)) ==
           cpu_to_le16(WLAN_FTYPE_MGMT | WLAN_STYPE_PROBE_REQ);
}

static inline u8 ieee80211_is_beacon(le16 fc)
{
    fc = le_to_host16(fc);
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline u8 ieee80211_is_assoc_req(uint16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_FC_STYPE)) ==
           cpu_to_le16(WLAN_FTYPE_MGMT | WLAN_STYPE_ASSOC_REQ);
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline uint8 ieee80211_is_reassoc_req(uint16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_FC_STYPE)) ==
           cpu_to_le16(WLAN_FTYPE_MGMT | WLAN_STYPE_REASSOC_REQ);
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_disassoc(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_FC_STYPE)) ==
           cpu_to_le16(WLAN_FTYPE_MGMT | WLAN_STYPE_DISASSOC);
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_auth(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_FC_STYPE)) ==
           cpu_to_le16(WLAN_FTYPE_MGMT | WLAN_STYPE_AUTH);
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_deauth(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_FC_STYPE)) ==
           cpu_to_le16(WLAN_FTYPE_MGMT | WLAN_STYPE_DEAUTH);
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_cts(le16 fc)
{
    return (fc & cpu_to_le16(WLAN_FC_FTYPE | WLAN_FC_STYPE)) ==
            cpu_to_le16(WLAN_FTYPE_CTL | WLAN_STYPE_CTS);
}
...
{
    return ((fc & (WLAN_FC_FTYPE | WLAN_FC_STYPE | WLAN_FC_PVER)) ==
                 (WLAN_FTYPE_DATA | WLAN_STYPE_QOS_NULLFUNC));
}
...
typedef enum {
    S1G_INDICATION_STATIC  = 0,
    S1G_INDICATION_DYNAMIC = 1,
